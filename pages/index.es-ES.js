    ...
    return (
        <div className="index-body select-none">
            ...
            <div className="index-banner">
                <div className="index-padding banner-content">
                    ...
                    <div className="button-wrapper flex" style={{marginTop: 40}}>
                        <a className="text-current no-underline banner-button" href="/docs">Documentaci&oacute;n</a>
                        <a className="source-button text-current no-underline banner-button" href="https://github.com/oas-tools" target="_blank" rel="noreferrer">
                            ...
                            <span className="ml-2">C&oacute;digo fuente</span>
                        </a>
                    </div>
                </div>
            ...
            <div className="relative index-functionalities index-padding">
                ...
                <div>
                    <span>
                        <h2>SwaggerUI integrada</h2>
                        <p>Al estar construido en torno a la especificaci&oacute;n OpenAPI, OAS Tools cuenta con la integraci&oacute;n de la interfaz de Swagger, completamente personalizable gracias a la arquitectura modular y configurable del sistema.</p>
                    </span>
                ...
                <div>
                    <span>
                        ...
                        <p>La herramienta de l&iacute;nea de comandos ofrece una interfaz interactiva a trav&eacute;s de la cual es posible crear un nuevo servicio REST a partir de un documento OpenAPI, un nuevo m&oacute;dulo, un entorno de desarrollo e incluso una declaraci&oacute;n OpenAPI 3.X a partir de un recurso JSON o YAML.</p>
                    </span>
            ...
            <div className="relative index-preview index-padding" style={{paddingTop: 100, paddingBottom: 100}}>
                <h1 className="bg-white dark:bg-dark">PREVISUALIZACI&Oacute;N</h1>
                <h3>De la definici&oacute;n a la realidad en una instrucci&oacute;n</h3>
                <iframe
                    src="https://stackblitz.com/edit/oas-tools-starter?embed=1&file=starter-project/api/oas-file.yaml"
